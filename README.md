...
| <a name="input_asg_desired_capacity"></a> [asg\_desired\_capacity](#input\_asg\_desired\_capacity) | The created ASG will have this number of instances at desired | `string` | `"2"` | no |
